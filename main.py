...
class LeftPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        char_scroll = ScrollView(size_hint=(1, 0.25), do_scroll_x=False)
        ...
        enemy_scroll = ScrollView(size_hint=(1, 0.25), do_scroll_x=False)
        ...
        detail_scroll = ScrollView(size_hint=(1, 0.3), do_scroll_x=False)
...
class CenterPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        result_scroll = ScrollView(size_hint=(1, 0.35), do_scroll_x=False)
    ...
    def __init__(self, app, **kwargs):
        ...
        try:
            ...
            if is_android and is_portrait:
                ...
                left_scroll = ScrollView(do_scroll_x=False)
                ...
                # 中栏 (判定面板) - 可滚动
                center_scroll = ScrollView(do_scroll_x=False)
