...
class LeftPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        char_scroll = ScrollView(size_hint=(1, 0.25), do_scroll_x=False, do_scroll_y=True)
        ...
        enemy_scroll = ScrollView(size_hint=(1, 0.25), do_scroll_x=False, do_scroll_y=True)
        ...
        detail_scroll = ScrollView(size_hint=(1, 0.3), do_scroll_x=False, do_scroll_y=True)
    ...
    def _make_char_button(self, entity, is_enemy=False):
        ...
        btn = Button(
            ...
            text=display, halign="left", font_size=sp(10),
...
class CenterPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        result_scroll = ScrollView(size_hint=(1, 0.35), do_scroll_x=False, do_scroll_y=True)
...
class RightPanel(BoxLayout):
    ...
    def _build_ui(self):
        ...
        log_scroll = ScrollView(do_scroll_x=False, do_scroll_y=True)
    ...
    def __init__(self, app, **kwargs):
        ...
        try:
            ...
            if is_android and is_portrait:
                ...
                center_scroll = ScrollView(do_scroll_x=False, do_scroll_y=True)
